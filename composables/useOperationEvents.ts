...
export const ACTION_LABELS: Record<string, string> = {
  ...
  table_qr_accepted: 'Pedido QR en mesa aceptado',
  table_qr_rejected: 'Pedido QR en mesa rechazado',
  ...
  payment_agreement_created: 'Acuerdo de pago creado',
  payment_agreement_updated: 'Acuerdo de pago actualizado',
  payment_agreement_deleted: 'Acuerdo de pago eliminado',
...
export const operationActionI18nKeys: Record<string, string> = {
  ...
  table_qr_accepted: 'actionTableQrAccepted',
  table_qr_rejected: 'actionTableQrRejected',
  ...
  supplier_created: 'actionSupplierCreated',
  supplier_updated: 'actionSupplierUpdated',
  supplier_deleted: 'actionSupplierDeleted',
  payment_agreement_created: 'actionPaymentAgreementCreated',
  payment_agreement_updated: 'actionPaymentAgreementUpdated',
  payment_agreement_deleted: 'actionPaymentAgreementDeleted',
