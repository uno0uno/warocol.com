...
export const WAREHOUSE_COPY = {
  ...
  typeFood: 'Alimento',
  typeFoodDescription: 'Peso o volumen · gr, ml, kg',
  typeSupply: 'Insumo',
  typeSupplyDescription: 'Unidad fija · und (caja, paquete…)',
  ...
  purchaseItemLineRequired: 'Artículo de bodega *',
  purchaseItemsHelper:
    'Busca alimentos, servicios e insumos en un solo campo. El tipo aparece como etiqueta en cada resultado.',
  purchaseSearchPlaceholder: 'Buscar alimento, servicio o insumo...',
