    ...
    locales: [
      {
        ...
        language: 'es-CO',
        name: 'Español',
        files: ['es/shell.json', 'es/common.json', 'es/pos.json', 'es/operaciones.json', 'es/cocina.json', 'es/ventas.json', 'es/facturacion.json', 'es/abastecimiento.json', 'es/menu.json'],
      },
      {
        code: 'en',
        language: 'en-US',
        name: 'English',
        files: ['en/shell.json', 'en/common.json', 'en/pos.json', 'en/operaciones.json', 'en/cocina.json', 'en/ventas.json', 'en/facturacion.json', 'en/abastecimiento.json', 'en/menu.json'],
      },
    ],
    lazy: true,
    langDir: 'locales',
