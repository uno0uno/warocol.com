    ...
    locales: [
      {
        ...
        language: 'es-CO',
        name: 'Español',
        files: ['es/shell.json', 'es/common.json', 'es/pos.json', 'es/operaciones.json', 'es/cocina.json', 'es/ventas.json', 'es/facturacion.json', 'es/abastecimiento.json', 'es/menu.json', 'es/finanzas.json', 'es/analitica.json', 'es/equipo.json'],
      },
      {
        code: 'en',
        language: 'en-US',
        name: 'English',
        files: ['en/shell.json', 'en/common.json', 'en/pos.json', 'en/operaciones.json', 'en/cocina.json', 'en/ventas.json', 'en/facturacion.json', 'en/abastecimiento.json', 'en/menu.json', 'en/finanzas.json', 'en/analitica.json', 'en/equipo.json'],
      },
    ],
    lazy: true,
    langDir: 'locales',
