    ...
    locales: [
      {
        ...
        language: 'es-CO',
        name: 'Español',
        files: ['es/shell.json', 'es/common.json', 'es/pos.json', 'es/operaciones.json', 'es/cocina.json'],
      },
      {
        code: 'en',
        language: 'en-US',
        name: 'English',
        files: ['en/shell.json', 'en/common.json', 'en/pos.json', 'en/operaciones.json', 'en/cocina.json'],
      },
    ],
    lazy: true,
    langDir: 'locales',
