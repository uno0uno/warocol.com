...
Desde el módulo de Gastos llevas el control de todos los costos del negocio que no son compras de inventario: arriendo, servicios públicos, mantenimiento, publicidad, etc.
...
Columnas: fecha · categoría · recurrente · descripción · monto · acciones
...
**Gastos recurrentes:** si marcas recurrente, aparecen **Frecuencia** (mensual, quincenal, semanal) y **Fecha de fin** (opcional).
