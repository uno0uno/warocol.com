...
async function submit() {
  ...
  try {
    ...
    const payload = {
      ...
      description: '',
      image_url: null,
      price: form.value.es_cortesia ? 0 : form.value.price,
      es_cortesia: form.value.es_cortesia,
      category_id: form.value.category_id,
      preparation_time: 0,
      is_available: form.value.is_available,
      is_available_online: form.value.es_cortesia ? false : form.value.is_available,
      is_available_table_qr: form.value.es_cortesia ? false : form.value.is_available,
