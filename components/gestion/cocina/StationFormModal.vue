<template>
  <div>
    <!-- Desktop -->
    <UiModal v-model="openModel" :title="isEditing ? 'Editar Estación' : 'Nueva Estación'">
      <form @submit.prevent="handleSubmit" id="station-form-desktop" class="p-6 space-y-5">
        <!-- Name -->
        <div class="space-y-1.5">
          <label class="text-xs font-bold text-text-secondary uppercase tracking-wider">Nombre de la Estación</label>
          <input
            v-model="form.name"
            type="text"
            required
        ...
        <!-- Kitchen Name -->
        <div class="space-y-1.5">
          <label class="text-xs font-bold text-text-secondary uppercase tracking-wider">Nombre del Monitor (Opcional)</label>
          <input
        ...
        <div class="grid grid-cols-2 gap-4">
          <!-- Color -->
          <div class="space-y-1.5">
            <label class="text-xs font-bold text-text-secondary uppercase tracking-wider">Color</label>
          ...
          <!-- Order -->
          <div class="space-y-1.5">
            <label class="text-xs font-bold text-text-secondary uppercase tracking-wider">Orden</label>
            <input
    ...
    <!-- Mobile -->
    <UiBottomSheetModal v-model="openModel" :title="isEditing ? 'Editar Estación' : 'Nueva Estación'">
