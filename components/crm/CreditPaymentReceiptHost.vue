...
const receiptLines = computed(() => {
  ...
  return [
    ...
    {
      label: t('analitica.customerDetail.credit.receipt.ticketDateTime'),
...
<template>
  <Teleport to="body">
    <CrmStaffReceiptPrintTicket
      ...
      document-kind="crm-credit"
      :document-label="t('analitica.customerDetail.credit.receipt.ticketTitle')"
      :header-role-label="t('analitica.customerDetail.credit.receipt.establishmentRole')"
      :footer-banner="t('analitica.customerDetail.credit.receipt.ticketFooterBanner')"
      :footer-note="t('analitica.customerDetail.credit.receipt.ticketFooterNote')"
