          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-3">
              ...
              <div>
                ...
                <p class="text-sm text-text-secondary">Ingresa los detalles de la factura del proveedor</p>
              </div>
            </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await $fetch(`/api/suppliers/purchases/${props.purchaseId}/invoice`, {
      method: 'POST',
