      ...
      <div class="bg-card rounded-xl border border-border p-4">
        ...
        <div class="mt-3 pt-3 border-t border-border">
          ...
          <div v-if="showContact">
            ...
            <!-- Social Media -->
            <div v-if="hasSocialMedia" class="mt-3 flex gap-2">
              <a
                v-if="restaurant.social_media?.whatsapp"
                :href="`https://wa.me/${restaurant.social_media.whatsapp.replace(/[^0-9]/g, '')}`"
                target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center justify-center w-11 h-11 rounded-xl bg-muted text-foreground hover:bg-[#25D366]/15 hover:text-[#25D366] transition-colors"
                aria-label="WhatsApp"
                title="WhatsApp"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center justify-center w-11 h-11 rounded-xl bg-muted text-foreground hover:bg-[#1877F2]/15 hover:text-[#1877F2] transition-colors"
                aria-label="Facebook"
                title="Facebook"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="inline-flex items-center justify-center w-11 h-11 rounded-xl bg-muted text-foreground hover:bg-[#E1306C]/15 hover:text-[#E1306C] transition-colors"
