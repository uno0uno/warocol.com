    ...
    <div v-else>
      ...
      <div v-if="floorLayout === 'grid'" key="tables-grid" class="pb-32">
        <div class="pos-floor-grid grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 items-stretch">
          ...
          <div class="h-full rounded-xl border-2 border-dashed border-border px-3 py-4 transition-colors duration-200 hover:border-primary/60 hover:bg-surface-secondary/30">
          <button
            type="button"
